...
def mutitaskLasso(X, y, L,alpha,beta =0.01,tol = 1e-24,sw = 0):
    ...
    weights,trl= multitask_lasso(X, y, L, lr=0.001, alpha=alpha, beta =beta, alpha_t=0.001, max_iter=100, #If not reduced the model generates really high values which the SVC cannot handle.
