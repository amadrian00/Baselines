...
def normalize(ori_data, flag='01'):
    ...
    if len(data.shape) > 1:   # 2-D
        N , K = data.shape
        minV = np.zeros(shape=N)
        maxV = np.zeros(shape=N)
...
if __name__ == '__main__':
    ...
    # Load ADNI data
    dataname = 'ADNI'
    sub_run1 = 1102 # Number of ADNI subjects
    ROI_num = 200 # Craddock number of ROIs
    path_run1 = '/DataCommon3/daheo/ABIDE/ABIDEI/ABIDEI_Provided_AtlasBOLD/cpac/filt_global/rois_cc200/'
